...
field_list = ["iter", "loss", "accuracy", "loss_bbox", "loss_cls", "rpn_loss_bbox", "rpn_loss_cls",
			  "person_face_accuracy", "person_face_loss_bbox", "person_face_loss_cls", "person_face_rpn_loss_bbox",
			  "person_face_rpn_loss_cls"]
field_tobe_list = ["accuracy", "loss_bbox", "loss_cls", "rpn_loss_bbox", "rpn_loss_cls",
				   "person_face_accuracy", "person_face_loss_bbox", "person_face_loss_cls", "person_face_rpn_loss_bbox",
				   "person_face_rpn_loss_cls"]
show_field_list = ["loss", "accuracy", "loss_bbox", "loss_cls", "rpn_loss_bbox", "rpn_loss_cls", "person_face_accuracy",
				   "person_face_loss_bbox", "person_face_loss_cls", "person_face_rpn_loss_bbox",
				   "person_face_rpn_loss_cls"]
